...
#  cbar.set_label('h [%]',fontdict=font)
  ...
  plt.plot(t0[n,:], gg_no[n,:]/1000,'-',color='k',linewidth=3,label='Without RR')
  plt.plot(t0[n,:], gg_rr[n,:]/1000,'-',color='b',linewidth=3,label='Classic RR')
  for n in range(5000):
...
#  plt.title('t='+str(round(t0[0,i],0))+' $T_0$',fontdict=font)
  ...
  fig.savefig('max_5000.png',format='png',dpi=160)
  plt.close("all")
