...
if __name__ == "__main__":
  ...
  plt.pcolormesh(x*0.51*1e-3, y, data_no.T, norm=colors.LogNorm(vmin=1, vmax=1e4), cmap=mycolor_jet)
...
#plt.title('electron at y='+str(round(y[n,0]/2/np.pi,4)),fontdict=font)
  ...
  fig = plt.gcf()
  fig.set_size_inches(25, 7.8)
#fig.set_size_inches(5, 4.5)
  fig.savefig('./wrap_dN_dE_time_T1000.png',format='png',dpi=160)
  plt.close("all")
